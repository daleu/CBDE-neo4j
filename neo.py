...
#ORDERS
session.run("CREATE (ord1:Order {o_key:'key1', o_order_date:'11/11/16', o_ship_priority:'2'})")
session.run("CREATE (ord2:Order {o_key:'key2', o_order_date:'12/11/16', o_ship_priority:'1'})")
session.run("CREATE (ord3:Order {o_key:'key3', o_order_date:'11/11/16', o_ship_priority:'3'})")
session.run("CREATE (ord4:Order {o_key:'key4', o_order_date:'12/11/16', o_ship_priority:'1'})")
session.run("CREATE (ord5:Order {o_key:'key5', o_order_date:'11/11/16', o_ship_priority:'2'})")
session.run("CREATE (ord6:Order {o_key:'key6', o_order_date:'12/11/16', o_ship_priority:'1'})")
session.run("CREATE (ord7:Order {o_key:'key7', o_order_date:'11/11/16', o_ship_priority:'3'})")
...
session.run("MATCH (a:Order),(b:Partsupp) WHERE a.o_key='key1' AND (b.ps_partkey='key1' AND b.ps_suppkey='key1') CREATE (a)-[r:Lineitem {l_returnflag:'1', l_linestatus:'shipped', l_quantity:'1', l_extended_price:'20', l_discount:'0.2', l_tax:'0.21',l_shipdate:'11/11/16'}]->(b)")
session.run("MATCH (a:Order),(b:Partsupp) WHERE a.o_key='key1' AND (b.ps_partkey='key1' AND b.ps_suppkey='key2') CREATE (a)-[r:Lineitem {l_returnflag:'0', l_linestatus:'shipped', l_quantity:'3', l_extended_price:'10', l_discount:'0', l_tax:'0.8',l_shipdate:'11/11/16'}]->(b)")

session.run("MATCH (a:Order),(b:Partsupp) WHERE a.o_key='key2' AND (b.ps_partkey='key1' AND b.ps_suppkey='key1') CREATE (a)-[r:Lineitem {l_returnflag:'1', l_linestatus:'shipped', l_quantity:'4', l_extended_price:'4', l_discount:'0.3', l_tax:'0.11',l_shipdate:'12/11/16'}]->(b)")
session.run("MATCH (a:Order),(b:Partsupp) WHERE a.o_key='key2' AND (b.ps_partkey='key2' AND b.ps_suppkey='key1') CREATE (a)-[r:Lineitem {l_returnflag:'1', l_linestatus:'ordered', l_quantity:'2', l_extended_price:'10', l_discount:'0.1', l_tax:'0.11',l_shipdate:'12/11/16'}]->(b)")
session.run("MATCH (a:Order),(b:Partsupp) WHERE a.o_key='key2' AND (b.ps_partkey='key4' AND b.ps_suppkey='key2') CREATE (a)-[r:Lineitem {l_returnflag:'0', l_linestatus:'shipped', l_quantity:'1', l_extended_price:'40', l_discount:'0.1', l_tax:'0.21',l_shipdate:'12/11/16'}]->(b)")

session.run("MATCH (a:Order),(b:Partsupp) WHERE a.o_key='key3' AND (b.ps_partkey='key1' AND b.ps_suppkey='key1') CREATE (a)-[r:Lineitem {l_returnflag:'0', l_linestatus:'ordered', l_quantity:'6', l_extended_price:'2', l_discount:'0.3', l_tax:'0.11',l_shipdate:'11/11/16'}]->(b)")
session.run("MATCH (a:Order),(b:Partsupp) WHERE a.o_key='key3' AND (b.ps_partkey='key3' AND b.ps_suppkey='key1') CREATE (a)-[r:Lineitem {l_returnflag:'1', l_linestatus:'shipped', l_quantity:'1', l_extended_price:'10', l_discount:'0.1', l_tax:'0.11',l_shipdate:'11/11/16'}]->(b)")
session.run("MATCH (a:Order),(b:Partsupp) WHERE a.o_key='key3' AND (b.ps_partkey='key4' AND b.ps_suppkey='key2') CREATE (a)-[r:Lineitem {l_returnflag:'0', l_linestatus:'shipped', l_quantity:'1', l_extended_price:'3', l_discount:'0', l_tax:'0.21',l_shipdate:'1/11/16'}]->(b)")
